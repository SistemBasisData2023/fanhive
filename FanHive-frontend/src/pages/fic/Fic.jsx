...
const Fic = () => {
  ...
  const [selectedChapter, setSelectedChapter] = useState(story.chapters[0]);
  ...
  return (
    <div className="fic-details">
      <div className="top-details">
        <img className="fic-cover" src={story.coverImage} alt={story.title} />
        <div className="fic-info">
          <div className="fic-edit-follow">
            <h2 className="fic-title">{story.title}</h2>
            <SettingsRoundedIcon />
          </div>
          <p className="fic-fandom">{story.fandom}</p>
          <p className="fic-author">by {story.author}</p>
          <p className="fic-status">{story.status}</p>
          {story.tags.length > 0 && (
          ...
          <p className="fic-synopsis">{story.synopsis}</p>
      ...
      <div className="chapter-picker">
        {story.chapters.map((chapter) => (
          <button
            ...
            className={selectedChapter.id === chapter.number ? "selected" : ""}
          >
